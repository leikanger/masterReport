...
\label{secBiologicalNeuralSystems}	
	...
	%Under: istadenfor "He", skriv "Ramon Y Cajal" 			TODO TODO Skriv om neste setning! TODO TODO
	%That the basis of intelligence is individual ``brain cells'' that process incoming transmissions and send output transmissions as a consequence of receiving enough depolarizing input transmissions.
...
\end{figure}
	...
	%TODO Skriv om setninga; Skriv heller at bruk denne som referance for resten av teksten..
%%%%%%
...
%TODO THREE er for spesifikt. fører til at man lurer på kva dei er. Enten skriv dei, eller skriv noke slikt som "noken"..
...
%TODO For langt hopp til neste setning.
...
% 	- nevne såvidt kva som skjer ved axon terminal (synaptic vesicles og NT). NT spres gjennom noko kalla syn.cleft, og exiterer eller inhibits postsyn neuron.
	...
	\label{ssecTheAxonAndActionPotential}
		%The axon hillock is the part of the axon that lies closest to the cell body of the neuron. ELLER NOKE: Lag overgang fra siste setninga i forrige avsnitt til dette avsnittet!
...
% TODO Trur eg skal skrive om dette heilt sist i dette avsnittet, for å lede inn på syn.trans.
		...
		After a successful opening of the voltage--gated ion channels in the axon membrane, internal mechanisms close the ion channels after a little while.
		...
		%This time interval is called the absolute refraction time and is important both to hinder the action potential to ``travel back'' along the axon and to limit the maximal firing frequency of the neuron.
...
\end{figure}
		...
		%Because of the number of connections and that the synaptic weight is plastic, neural networks are truly complex computational system.
...
% TAR VEKK SUBSECTION! (Signal Propagation in the Biological Neuron) KOMMENTERT UT!
%//{
