...
%[Her stod tidligare en analyse av feilen for de to ANN modellene]. Dette er flyttet inn i analysisOfTheTwoModels.tex
	...
	% Drit i RESTEN: eg har nok tekst, som det er. 
	% 	Or maybe not: This will be an important part of the discussion: Elements that should have been done differently. Do it later TODO
		%\subsection{Synaptic Transmission as the Derivative}
		%	In section \ref{ssecSynapticFlow}, synaptic flow is introduced.
		%	
		%	Referer til avsnittet som innfører synaptic flow.
